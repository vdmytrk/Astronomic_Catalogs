...
public class NGCICOpendatasoftExtensionConfiguration : IEntityTypeConfiguration<NGCICOpendatasoftExtension>
{
    public void Configure(EntityTypeBuilder<NGCICOpendatasoftExtension> builder)
    {
        builder.ToTable("NGCICOpendatasoft_Extension");
        ...
        builder.Property(e => e.OtherNames).HasColumnName("Ohter_names").HasMaxLength(400);
