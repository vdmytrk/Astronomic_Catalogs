...
namespace Astronomic_Catalogs.Areas.Admin.Controllers
{
    ...
    public class RolesController : Controller
    {
        ...
        {
            return View(await _context.AspNetRole.ToListAsync());
        }
        ...
        public async Task<IActionResult> Details(string id)
        {
            ...
            var aspNetRole = await _context.AspNetRole
        ...
        public async Task<IActionResult> Edit(string id)
        {
            ...
            var aspNetRole = await _context.AspNetRole.FindAsync(id);
            if (aspNetRole == null)
            {
                return NotFound();
            }
        ...
        public async Task<IActionResult> DeleteConfirmed(string id)
        {
            ...
            if (aspNetRole != null)
            {
                _context.AspNetRole.Remove(aspNetRole);
            }
        ...
        {
            return _context.AspNetRole.Any(e => e.Id == id);
        }
    }
}
