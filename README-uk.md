...
✨ Онлайн-деплой доступний тут: https://astrocatalogs.azurewebsites.net/  (*Початкове завантаження може виконуватися із затримкою через активацію бази даних після періоду неактивності.*)   

⚖️ База даних розміщена на **Azure SQL Server**, а код підтримується на **Azure DevOps**, з **GitHub як дзеркалом лише для читання**:  
*   [Основний репозиторій *(активна розробка)*](https://dev.azure.com/voldmytcOrganization2025-08/Astronomic%20Catalogs/_git/Astornomic_Solution)
*   [Дошка проекту та конвеєр](https://dev.azure.com/voldmytcOrganization2025-08/Astronomic%20Catalogs/_dashboards/dashboard/6804f651-e2a5-41ff-959d-6a732b8d369e)   
...
- [🧠 SQL-Дизайн Та Збережені Процедури](#🧠-**sql-дизайн-та-збережені-процедури**)
...
| **Логування**            | NLog (`NLog.config.<середовище>`) + користувацький проміжний шар + файлове логування на ранньому етапі |
...
*   **Кешування Результатів Збережених Процедур**  
    ...
    *   Логування співпадінь і неспівпадінь кешу, підтримка інвалідації за ключем або префіксом.
...
## 🔐 **Аутентифікація Та Авторизація**
Підтримуються як локальні, так і зовнішні способи:  
