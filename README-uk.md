...
| **Тестування**           | NUnit + FakeItEasy + EF Core (InMemory)                                             |
...
*   🧪 **Набір тестів** — Модульні тести з використанням заглушок та БД в оперативній памʼяті.  
...
*   **Тестування**  
    *   Tести розміщені у проєкті `ACTests.Tests` охоплюють логіки контролерів і сервісів в ізоляції за допомогою заглушок та *in-memory* EF.  
    *   Тестовий проєкт ілюстративний і обмежений — акцент лише на модульних тестах (без інтеграційного або сценарного покриття).
...
*   Розширення тестового покриття (інтеграційні та сценарні тести).  
